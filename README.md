...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/AWffpTe67C)
...
```sh
npx nx serve 3d-viewer
```

To create a production bundle:

```sh
npx nx build 3d-viewer
```

To see all available targets to run for a project, run:

```sh
npx nx show project 3d-viewer
```
